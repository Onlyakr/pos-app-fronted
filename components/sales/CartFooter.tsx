...
const CartFooter = () => {
  return (
    <ul className="grid h-15 grid-cols-8 items-center justify-center gap-2">
      <li className="bg-muted border-border col-span-2 flex h-9 items-center justify-center rounded-md border text-center">
      ...
      <li className="border-border bg-muted col-span-2 flex h-9 items-center justify-center rounded-md border text-center">
        A1234567
      </li>
    </ul>
  );
